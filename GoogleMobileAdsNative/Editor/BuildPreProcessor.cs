...
#endif
    {
        if (!AssetDatabase.IsValidFolder("Assets/GoogleMobileAdsNative"))
        {
            AssetDatabase.CreateFolder("Assets", "GoogleMobileAdsNative");
        }
        ...
        if (pathUtils.IsPackageRootPath())
        {
             ...
             */
            AssetDatabase.CopyAsset(linkXmlPath, "Assets/GoogleMobileAdsNative/link.xml");
        }
    }
}